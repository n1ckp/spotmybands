...
import {
  actionSpotifySearchArtists,
  actionClearSpotifyArtists,
} from "@utils/globalState/spotify";
...
const AddArtistsModal: React.FC<AddArtistsModalProps> = ({ children }) => {
  ...
  return (
    <>
      ...
      <ModalPanel open={open} onClose={() => setModalOpen(false)}>
        <div id={styles.container}>
          ...
          <div className={styles.artistsContainer}>{artistSearchResults}</div>
        </div>
      </ModalPanel>
    </>
  );
